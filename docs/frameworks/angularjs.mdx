...
This short set of instructions gets you up and running with Apollo Angular. This guide is taken from the apollo-angular getting started guide from [here](https://apollo-angular.com/docs/get-started)
...
```typescript
const uri = 'https://api.apito.io/secured/graphql'; // our GraphQL API
```
