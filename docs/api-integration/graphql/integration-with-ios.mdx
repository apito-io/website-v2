...
```sh
apollo schema:download --endpoint=https://api.apito.com/secured/graphql --header="Authorization: Bearer API_SECRET"
```
...
class NetworkManager {
    ...
    let graphEndpoint = "https://api.apito.com/secured/graphql"
